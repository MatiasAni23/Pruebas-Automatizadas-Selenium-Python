...
class Pruebas_retail(unittest.TestCase):
    CHROME_DRIVER_PATH = os.getenv('CHROME_DRIVER_PATH') #Ruta del driver de Chrome
    output_folder = os.getenv('OUTPUT_FOLDER') #Carpeta de salida para los videos
    ...
    def setUpClass(cls):
        ...
        # Ventana 4
        cls.driver4 = webdriver.Chrome(service=service, options=chrome_options)
        cls.driver4.get(cls.urls[3])
        hwnd4 = gw.getWindowsWithTitle(cls.driver4.title)[0]._hWnd
        print(f"Ventana 4 . Titulo: {cls.driver4.title}, HWND: {hwnd4}" )
        cls.drivers.append(cls.driver4)
        cls.hwnds.append(hwnd4)
        
        # Ventana 5
        cls.driver5 = webdriver.Chrome(service=service, options=chrome_options)
        cls.driver5.get(cls.urls[4])
        hwnd5 = gw.getWindowsWithTitle(cls.driver5.title)[0]._hWnd
        print(f"Ventana 5 - Titulo: {cls.driver5.title}, HWND: {hwnd5}")
        cls.drivers.append(cls.driver5)
        cls.hwnds.append(hwnd5)
    ...
    def grabar_multiples_ventanas(self, ventana_idx=0):
        ...
        windows_titles = ["Falabella", "Paris", "Ripley", "MercadoLibre", "Sodimac"]  # Títulos de las ventanas
    ...
    def test_02_boton_login(self):
        ...
        self.driver.execute_script("""
            ...
            setTimeout(() => { arguments[0].style.border='none'; }, 2000);
            """, 
            boton_login
        )
    ...
    def test_05_mis_compras(self):
        print("Test_05")
        print("Falabella")
        print("-" * 50)
        
        try:
            mis_compras = WebDriverWait(self.driver, 10).until(
                EC.presence_of_element_located((By.XPATH, '//*[@id="testId-userAction-orders"]'))
            )
            ...
            # Hacer scroll al botón
            self.driver.execute_script("arguments[0].scrollIntoView({block: 'center'});", mis_compras)
            ...
            print(f"Error al buscar el boton de mis compras: {e}")
        ...
        fin_carga = time.perf_counter()
        carga = fin_carga - inicio_carga
        print(f"El tiempo de carga de la pagina luego de presionar el boton 'Mis Compras' es de: {carga:2f} segundos")

        time.sleep(3)
        # Almacenar resultados
        self.log_performance("Carga de pagina luego de presionar el boton de 'Mis Compras' - Falabella", inicio_carga, fin_carga)
    ...
    def test_06_carga_pagina_paris(self):
    ...
    def test_07_boton_login_paris(self):
        print("Test_02")
        print("Paris")
        print("-" * 50)
    ...
    def test_08_iniciar_sesion_paris(self):
    ...
    def test_09_busqueda_producto(self):
        print("Test_04")
        print("Paris")
        print("-" * 50)
    ...
    def test_10_mis_compras(self):
        ...
        try:
            ...
            boton_cuenta = WebDriverWait(self.driver2, 10).until(
                EC.presence_of_element_located((By.XPATH, '/html/body/header/div[2]/div/nav/div[4]/div/div[1]/div/button'))
            )
            
            actions = ActionChains(self.driver2)
            actions.move_to_element(boton_cuenta).click_and_hold().perform()  # Holdear el mouse sobre el botón
            print("Mouse holdeado sobre el botón de login")
            ...
            # Buscar y hacer clic en el botón interno
            boton_mis_compras = WebDriverWait(self.driver2, 10).until(
                EC.element_to_be_clickable((By.XPATH, '/html/body/header/div[2]/div/nav/div[4]/div/div[1]/div/div/div/div/div/div[1]/div/a'))
            )
            print("Botón interno de inicio de sesión encontrado")
            ...
            # Mover el mouse al botón interno y hacer clic
            inicio_carga = time.perf_counter()
            actions.move_to_element(boton_mis_compras).click().perform()
            print("Clic realizado en el boton 'Mis Compras' dentro del menú")
        except Exception as e:
            print(f"Error al buscar o hacer clic en el boton interno de 'Mis Compras' - Paris.cl: {e}")
        ...
        time.sleep(3)
        self.log_performance("Carga de pagina luego de presionar el boton 'Mis compras' - Paris.cl",inicio_carga, fin_carga)
    ...
    def test_11_carga_pagina_ripley(self):
    ...
    def test_12_iniciar_sesion(self):
    ...
    def test_13_buscar_producto(self):
    ...
    def test_14_seleccionar_producto(self):
    ...
    # Testeo para agregar productos al carrito

    def test_15_agregar_carrito(self):
    ...
    def test_17_click_elemento_compras(self):
    ...
    def test_18_click_solicitudes(self):
    ...
    def test_19_click_ripley_puntos(self):
    ...
    def test_20_carga_Mercado_Libre(self):
        
        self.grabar_multiples_ventanas(ventana_idx=3)
        ...
        inicio_carga = time.perf_counter()
        try:
            WebDriverWait(self.driver4, 10).until(
                lambda d: d.execute_script("return document.readyState") == "complete"
            )
        ...
        print(f"El tiempo de carga de la pagina fue de {carga:.2f} segundos - MercadoLibre")
        # Almacenar el tiempo de carga en el archivo log
        self.log_performance("Carga de la pagina principal - Mercado Libre", inicio_carga, fin_carga)
        
    def test_21_busqueda_producto(self):
        ...
        # Presionar barra de busqueda
        try:
            presionar_barra = WebDriverWait(self.driver4,  30).until(
                EC.presence_of_element_located((By.XPATH, '//*[@id="cb1-edit"]'))
            )
            
            self.driver4.execute_script("""
                arguments[0].style.border='3px solid red'; 
                arguments[0].style.transition='border 0.3s ease-in-out';
                setTimeout(() => { arguments[0].style.border='none'; }, 2000);
                """, 
        ...
        #Buscar producto
        try:
            buscar_producto = WebDriverWait(self.driver4, 30).until(
                EC.presence_of_element_located((By.XPATH, '//*[@id="cb1-edit"]'))
            )
            buscar_producto.send_keys("Cepillo electrico")
            buscar_producto.send_keys(Keys.ENTER)
    ...
    def test_22_seleccionar_producto(self):
        ...
        try:
            seleccionar_producto = WebDriverWait(self.driver4, 30).until(
                EC.presence_of_element_located((By.XPATH, '/html/body/main/div/div[3]/section/ol/li[6]/div/div/div[2]/h3/a'))
            )
            ...
            print(f"Error al seleccionar el producto")
        ...
        print(f"El tiempo de carga de la pagina luego de seleccionar el producto es de {carga:.2f} segundos - Mercado Libre")
        
        # Almacenar resultados
        self.log_performance("Carga de pagina luego de presionar el producto y cargar la pagina - Mercado Libre", inicio_carga, fin_carga)
        
        time.sleep(2)
        
        self.detener_grabacion(ventana_idx=3)
        
        time.sleep(5)
    
    def test_23_carga_Sodimac(self):
        
        self.grabar_multiples_ventanas(ventana_idx=4)
        ...
        try:
            WebDriverWait(self.driver5, 10).until(
                lambda d: d.execute_script("return document.readyState") == "complete"
            )
            print("Pagina cargada completamente")
        except Exception as e:
        ...
        # Imprimir el resultado
        print(f"El tiempo de carga de la pagina fue de {carga:.2f} segundos - Sodimac")
        # Almacenar el tiempo de carga en el archivo log
        self.log_performance("Carga de la pagina principal - Sodimac", inicio_carga, fin_carga)
        
        time.sleep(2)
        
    def test_24_buscar_producto(self):
        ...
        # Presionar barra de busqueda
        try:
            presionar_barra = WebDriverWait(self.driver5,  30).until(
                EC.presence_of_element_located((By.XPATH, '//*[@id="testId-SearchBar-InputDY"]'))
            )
            
            self.driver5.execute_script("""
                arguments[0].style.border='3px solid red'; 
                arguments[0].style.transition='border 0.3s ease-in-out';
                setTimeout(() => { arguments[0].style.border='none'; }, 2000);
                """, 
        ...
        #Buscar producto
        try:
            buscar_producto = WebDriverWait(self.driver5, 30).until(
                EC.presence_of_element_located((By.XPATH, '//*[@id="testId-SearchBar-InputDY"]'))
            )
            buscar_producto.send_keys("Silla ergonómica")
            time.sleep(2)
            buscar_producto.send_keys(Keys.ENTER)
            print("Producto ingresado correctamente")
        except Exception as e:
    ...
    def test_25_seleccionar_producto(self):
        ...
        try:
            seleccionar_producto = WebDriverWait(self.driver5, 30).until(
                EC.presence_of_element_located((By.XPATH, '/html/body/div[2]/div/div/div[2]/section[2]/div/div[3]/div[4]/a/div[2]'))
            )
            ...
            inicio_carga = time.perf_counter()
            seleccionar_producto.click()
            print("Se selecciono el producto correctamente")
            
        except Exception as e:
            print(f"No se pudo seleccionar producto: {e}")
        
        # Esperar a que la pagina cargue
        try:
            WebDriverWait(self.driver5, 30).until(
                lambda d: d.execute_script("return document.readyState") == "complete"
            )
            print("La pagina se ha cargado correctamente")
        except Exception as e:
        ...
        carga = fin_carga - inicio_carga
        # Imprimir resultado
        print(f"El tiempo de carga de la pagina luego de seleccionar un producto es de {carga:.2f}")
        
        # Almacenar redultado
        self.log_performance("Carga de pagina luego de presionar el producto y cargar la pagina - Sodimac", inicio_carga, fin_carga)
        
        time.sleep(2)
                
        self.detener_grabacion(ventana_idx=4)
